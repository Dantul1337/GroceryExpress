    ...
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-2xl font-semibold text-app-green">Мои адреса</h1>
          <button
            onClick={() => {
              resetForm();
              setShowForm(true);
            ...
            <PlusIcon className="size-4" /> Добавить адрес
          </button>
        </div>
        {showForm && <AddressForm resetForm={resetForm} handleSubmit={handleSubmit} form={form} setForm={setForm} editingId={editingId}/>}
        {
          loading ? (
            ...
            <div className='text-center py-16'>
              ...
              <h2 className='text-lg font-semibold text-app-green mb-2'>Нет сохранённых адресов</h2>
              <p className='text-sm text-app-text-light'>Добавьте адрес для быстрого оформления заказа</p>
            </div>
          ) : (
