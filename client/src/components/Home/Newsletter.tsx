  ...
  return (
    <section className="bg-white py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-auto shadow-xs mt-32 mb-20">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h2 className="text-3xl font-semibold text-app-green mb-4">Подпишитесь на новости</h2>
        <p className="text-app-text-light mb-8 text-base">
          Получайте еженедельные новости о свежих продуктах, сезонных предложениях и эксклюзивных скидках прямо на почту.
        </p>
